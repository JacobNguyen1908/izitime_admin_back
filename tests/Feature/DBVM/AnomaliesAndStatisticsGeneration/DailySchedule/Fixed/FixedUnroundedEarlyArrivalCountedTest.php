...
class FixedUnroundedEarlyArrivalCountedTest extends TestCase
{
    ...
    public function test_daily_schedule_fixed_unrounded_early_arrival_counted_with_break() {
        // Employee: 7, date: '31-08-2021'
        $this->authenticated();
        $employee_id = 7;
        $date = '2021-08-31';
        // Daily schedule
        ...
        $response->assertJson([
            ...
            "name"=>"Horaires fixes / arrivée anticipée comptée / temps compté non arrondi / avec pause",
            "type"=>"Fixed",
            "abbreviation"=>"HFAACTCNAAP",
            "max_counted_time"=>"07:15:00.0000000",
            "theorical_work_time"=>"07:15:00.0000000",
            ...
            "timeslots"=> [
                [
                    "duration_start_end"=>"428",
                    "practical_total_duration"=>"428",
                    "theoretical_break_duration"=>"45",
                    "practical_break_duration"=>"48",
        ...
        $response->assertJson([
            [
                ...
                "description"=>"Theoretical: 435 , Practical: 428",
                "validated"=>"0",
                "show"=>"1",
            ...
            [
                ...
                "date"=>"2021-08-31",
                "level"=>"Timeslot 1",
                "description"=>"{\"theoretical_duration\" : \"45\",\"practical_duration\" : \"48\",\"practical_break_start\" : \"2021-08-31T14:14:49\",\"practical_break_end\" : \"2021-08-31T15:02:00\",\"exceed\" : \"3\"}",
                "validated"=>"0",
                "show"=>"1",
    ...
    public function test_daily_schedule_fixed_unrounded_early_arrival_counted_without_break() {
        // Employee: 7, date: '30-08-2021'
        $this->authenticated();
        $employee_id = 7;
        $date = '2021-08-30';
        // Daily schedule
        ...
        $response->assertJson([
            ...
            "name"=>"Horaires fixes / arrivée anticipée comptée / temps compté non arrondi / sans pause",
            "type"=>"Fixed",
            "abbreviation"=>"HFAACTCNASP",
            "max_counted_time"=>"12:00:00.0000000",
            "theorical_work_time"=>"12:00:00.0000000",
            "early_arrival_counted"=>"1",
            "round_option"=>"0",
            "round_time"=>"0",
            "counted_work_time_night"=>"0",
            "timeslots"=> [
                [
                    "duration_start_end"=>"741",
                    "practical_total_duration"=>"741",
        ...
        $response->assertJson([
            [
                ...
                "date"=>"2021-08-30",
                "level"=>"Daily schedule",
                "description"=>"Theoretical: 720 , Practical: 741",
                "validated"=>"0",
                "show"=>"1",
                "type"=>"Max work time exceeded"
            ]
        ]);
    }
}
