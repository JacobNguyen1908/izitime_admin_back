...
class FixedRoundedEarlyArrivalNonCountedTest extends TestCase
{
    ...
    public function test_daily_schedule_fixed_rounded_early_arrival_non_counted_without_break() {
    ...
    public function test_daily_schedule_fixed_rounded_early_arrival_non_counted_with_break() {
